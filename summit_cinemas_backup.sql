...
--
-- Host: localhost    Database: javafx_demo
-- ------------------------------------------------------
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'd9d17f51-2231-11f1-94d8-00f1f3ab045d:1-13';
...
CREATE TABLE `movies` (
  ...
  `description` text,
  `poster_filename` varchar(100) DEFAULT NULL,
...
INSERT INTO `movies` VALUES (1,'ADAD','','dd',NULL,NULL);
...
INSERT INTO `tbl_user` VALUES (1,'john','pass123','San Fernando'),(2,'mary','pass456','Couva'),(3,'admin','admin123','Port of Spain');
...
INSERT INTO `users` VALUES (1,'admin','admin@summit.com','admin123','Admin User',NULL,'2026-03-24 18:40:19','admin');
...
-- Dump completed on 2026-04-02 19:05:09
